    ...
    private void routeplanToNavi(BNRoutePlanNode.CoordinateType coType,double slongitude,double slatitude,double elongitude,double elatitude,String sNodeName,String eNodeName) {
        ...
        switch (coType) {
            ...
            case WGS84: {
                ...
                sNode = new BNRoutePlanNode(slongitude, slatitude, "深宇科技园", null, WGS84);
                eNode = new BNRoutePlanNode(elongitude,elatitude, "广东省深圳市龙岗区宝梓中路9号", null, WGS84);
                break;
            }
            case BD09_MC: {
                sNode = new BNRoutePlanNode(slongitude, slatitude, "深宇科技园", null, BD09_MC);
                eNode = new BNRoutePlanNode(elongitude,elatitude, "广东省深圳市龙岗区宝梓中路9号", null, BD09_MC);
                break;
            }
            case BD09LL: {
                sNode = new BNRoutePlanNode(slongitude, slatitude, "深宇科技园", null, BD09LL);
                eNode = new BNRoutePlanNode(elongitude,elatitude, "广东省深圳市龙岗区宝梓中路9号", null, BD09LL);
                break;
            }
            default:
                ;
