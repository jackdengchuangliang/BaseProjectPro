...
public class WTMBaiduLocation implements BDLocationListener{
     ...
     * 获取经纬度的类
     * @param context 上下文
     * @param coorType 坐标系类型,可选参数:gcj02,gps,bd09,bd09ll
     */
    ...
    public void onReceiveLocation(BDLocation bdLocation) {
        ...
        if (62<=mLocType&&mLocType<=68)
            Toast.makeText(mContext,"网络链接异常",Toast.LENGTH_SHORT).show();
        if (162<=mLocType&&mLocType<=700)
            Toast.makeText(mContext,"定位参数异常,请联系客服",Toast.LENGTH_SHORT).show();
