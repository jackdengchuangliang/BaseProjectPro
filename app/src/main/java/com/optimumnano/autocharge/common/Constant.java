...
public class Constant {
    public static final String HOST = "192.168.101.148";

    public static final String PORT = "4711";
    public static final String URL_BASE = "http://" + HOST + ":" + PORT + "/";
    ...
    public static final String URL_LOGOUT = URL_BASE + "app/user/logout";
